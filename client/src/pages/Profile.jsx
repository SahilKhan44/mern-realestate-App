...
export default function Profile() {
  ...
  const handleSubmit = async(e) => {
    e.preventDefault();
    console.log('Current User in updateUser:', currentUser);
  ...
  return (
    <div className='p-3 mx-w-lg mx-auto'>
      <h1 className='text-3xl font-semibold text-center my-7 text-cyan-800 hover:text-cyan-500'> User Profile</h1>
      ...
      <form onSubmit = {handleSubmit} className=' flex flex-col gap-4 '>
        ...
        <p className='text-sm self-center'>
          ...
          <span className='text-red-800'>
            Error Image Upload (Image less than 2 mb)
          </span> ) : 
      ...
      <div className=' flex justify-between mt-5 '>
        <span onClick={handleDleteUser} className='text-red-800 cursor-pointer font-semibold'>
          Delete Account
        </span>
      ...
      <p className='text-green-800 mt-5 text-center font-semibold'>{updateSuccess ? 'User is updated Successfully!' : ''}</p>
    </div>
  )
}
